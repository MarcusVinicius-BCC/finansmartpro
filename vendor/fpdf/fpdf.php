...
protected $PageInfo;           // array with page information
...
protected $CurrentFont;        // current font information
...
protected $nbevents;           // number of registered events
protected $AutoPageBreak;      // automatic page break
protected $PageBreakTrigger;   // threshold for auto page break
...
protected function _dochecks()
{
	...
	if(extension_loaded('mbstring') && ini_get('mbstring.func_overload')!='0')
		$this->Error('mbstring extension with func_overload set to '.ini_get('mbstring.func_overload').' is not compatible with FPDF. Please disable it from your php.ini or switch it to "0".');
	// Check libgd extension
...
protected function _putcatalog()
{
	...
	$this->_put('/ViewerPreferences <</Direction /L2R>>');
}
