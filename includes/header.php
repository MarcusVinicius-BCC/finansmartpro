...
<head>
    ...
    <?php endif; ?>
    <?php if (in_array($current_page, ['dashboard.php', 'index.php'])): ?>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="user-section mt-auto">
                <div class="user-info">
                    ...
                    <button id="themeToggle" class="ms-2" aria-label="Alternar tema">
...
<?php else: ?>
    <?php if($current_page === 'index.php'): ?>
        <div class="position-absolute end-0 top-0 p-4">
            <button id="themeToggle" class="btn btn-outline-light ms-2" aria-label="Alternar tema">
                <i class="fas fa-moon"></i>
            </button>
        </div>
    <?php elseif(!isset($_SESSION['user_id'])): ?>
        ...
        <div class="position-absolute end-0 top-0 p-4">
            <button id="themeToggle" class="btn btn-outline-secondary" aria-label="Alternar tema">
                <i class="fas fa-moon"></i>
            </button>
        </div>
    <?php endif; ?>
